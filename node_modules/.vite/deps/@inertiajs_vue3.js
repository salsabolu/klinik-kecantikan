...
var objectsAreEqual = (obj1, obj2, excludeKeys) => {
  ...
  for (const key2 in obj1) {
    ...
    if (!compareValues2(obj1[key2], obj2[key2])) {
      return false;
    }
  }
  return true;
  ...
  const form = reactive({
    ...
    data() {
      return Object.keys(defaults2).reduce((carry, key2) => {
        return set2(carry, key2, get(this, key2));
      }, {});
    },
    transform(callback) {
      transform2 = callback;
    ...
    defaults(fieldOrFields, maybeValue) {
      ...
      if (typeof fieldOrFields === "undefined") {
        ...
        defaults2 = typeof fieldOrFields === "string" ? set2(cloneDeep(defaults2), fieldOrFields, maybeValue) : Object.assign({}, cloneDeep(defaults2), fieldOrFields);
      }
      return this;
    },
    reset(...fields) {
      ...
      if (fields.length === 0) {
        ...
        fields.filter((key2) => has(clonedData, key2)).forEach((key2) => {
          set2(defaults2, key2, get(clonedData, key2));
          set2(this, key2, get(resolvedData, key2));
        });
      }
      return this;
    },
...
var Link = defineComponent({
  ...
  setup(props, { slots, attrs }) {
    ...
    const as = computed(() => method2.value !== "get" ? "button" : props.as.toLowerCase());
